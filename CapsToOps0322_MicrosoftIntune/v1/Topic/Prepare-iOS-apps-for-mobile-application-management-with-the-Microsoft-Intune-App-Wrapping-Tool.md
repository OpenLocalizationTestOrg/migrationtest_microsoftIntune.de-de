...
2.  Nach Abschluss der Verarbeitung wird eine Nachricht wie **Anwendungs-Wrapping erfolgreich** angezeigt.
    ...
    Falls ein Fehler auftritt, finden Sie Hilfe-Informationen unter [Fehlermeldungen](../Topic/Prepare-iOS-apps-for-mobile-application-management-with-the-Microsoft-Intune-App-Wrapping-Tool.md#BKMK_Error).
