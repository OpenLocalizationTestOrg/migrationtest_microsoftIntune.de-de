...
|**0x80043005**|Der Clientcomputer wurde abgekoppelt.|Warten Sie einige Stunden, entfernen Sie ältere Versionen der Clientsoftware von dem Computer, und versuchen Sie dann erneut, die Clientsoftware auf dem Computer zu installieren. Weitere Anweisungen finden Sie unter [What to do if the client will not uninstall from the Microsoft Intune administrator console](../Topic/Troubleshoot-Endpoint-Protection-in-Microsoft-Intune.md#BKMK_Whattodo).|
