---
title: Sicherheitsrichtlinieneinstellungen f&#252;r mobile Ger&#228;te in Microsoft Intune
ms.custom: na
ms.reviewer: na
...
4.  Im Abschnitt [Policy settings for mobile devices](../Topic/Mobile-device-security-policy-settings-in-Microsoft-Intune.md#BKMK_Settings) in diesem Thema finden Sie Informationen zu den Einstellungen, die Sie konfigurieren können.
